...
export const GlobalStyle = StyleSheet.create({
  ...
  Outfit_Regular_button: { fontFamily: fontFamily.outfitRegular, ...font.button },
  ...
  Outfit_Extrabold_button: { fontFamily: fontFamily.outfitExtrabold, ...font.button },
  Outfit_Extrabold_body: { fontFamily: fontFamily.outfitExtrabold, ...font.body },
  Outfit_Extrabold_small: { fontFamily: fontFamily.outfitExtrabold, ...font.small },
  ...
  Outfit_Extralight_button: { fontFamily: fontFamily.outfitExtralight, ...font.button },
  Outfit_Extralight_body: { fontFamily: fontFamily.outfitExtralight, ...font.body },
  Outfit_Extralight_small: { fontFamily: fontFamily.outfitExtralight, ...font.small },
  ...
  Outfit_Semibold_button: { fontFamily: fontFamily.outfitSemibold, ...font.button },
  Outfit_Semibold_body: { fontFamily: fontFamily.outfitSemibold, ...font.body },
  Outfit_Semibold_small: { fontFamily: fontFamily.outfitSemibold, ...font.small },
